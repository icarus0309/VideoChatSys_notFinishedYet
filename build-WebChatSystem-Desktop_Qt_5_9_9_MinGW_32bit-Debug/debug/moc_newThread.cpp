...
#include "../../WebChatSystem/newThread.h"
...
QT_MOC_LITERAL(3, 19, 4), // "Pack"
QT_MOC_LITERAL(4, 24, 7), // "upLogin"
QT_MOC_LITERAL(5, 32, 6) // "onRead"

    },
    "newThread\0sendMsg\0\0Pack\0upLogin\0onRead"
};
...
void newThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMsg((*reinterpret_cast< Pack(*)>(_a[1]))); break;
        case 1: _t->upLogin((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            typedef void (newThread::*_t)(Pack );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&newThread::sendMsg)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (newThread::*_t)(QString , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&newThread::upLogin)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void newThread::sendMsg(Pack _t1)
{
...
// SIGNAL 1
void newThread::upLogin(QString _t1, int _t2)
{
