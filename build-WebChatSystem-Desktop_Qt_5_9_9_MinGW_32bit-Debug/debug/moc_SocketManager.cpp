...
#include "../../WebChatSystem/SocketManager.h"
...
QT_MOC_LITERAL(1, 14, 8), // "sigWrite"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 11), // "QTcpSocket*"
QT_MOC_LITERAL(4, 36, 6), // "socket"
QT_MOC_LITERAL(5, 43, 5), // "Pack&"
QT_MOC_LITERAL(6, 49, 3) // "len"

    },
    "SocketManager\0sigWrite\0\0QTcpSocket*\0"
    "socket\0Pack&\0len"
};
...
static const uint qt_meta_data_SocketManager[] = {
 ...
 // signals: parameters
    QMetaType::Void, 0x80000000 | 3, 0x80000000 | 5, QMetaType::Int,    4,    2,    6,
...
void SocketManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigWrite((*reinterpret_cast< QTcpSocket*(*)>(_a[1])),(*reinterpret_cast< Pack(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            typedef void (SocketManager::*_t)(QTcpSocket * , Pack & , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketManager::sigWrite)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SocketManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SocketManager.data,
      qt_meta_data_SocketManager,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void SocketManager::sigWrite(QTcpSocket * _t1, Pack & _t2, int _t3)
{
