...
#include "../../WebChatSystem/ClientSocket.h"
...
QT_MOC_LITERAL(8, 63, 11) // "onReadyRead"

    },
    "ClientSocket\0sigWrite\0\0QTcpSocket*\0"
    "socket\0const char*\0data\0len\0onReadyRead"
};
...
void ClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientSocket::sigWrite)) {
                *result = 0;
                return;
            }
        }
