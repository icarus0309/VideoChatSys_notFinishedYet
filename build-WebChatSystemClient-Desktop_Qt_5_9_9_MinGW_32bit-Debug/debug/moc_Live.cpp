...
#include "../../WebChatSystemClient/Live.h"
...
QT_MOC_LITERAL(1, 5, 13), // "closeLiveroom"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "Live\0closeLiveroom\0"
};
...
void Live::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closeLiveroom(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Live::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Live::closeLiveroom)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Live::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Live.data,
      qt_meta_data_Live,  qt_static_metacall, nullptr, nullptr}
};
