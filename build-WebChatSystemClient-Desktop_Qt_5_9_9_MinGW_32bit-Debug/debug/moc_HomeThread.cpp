/****************************************************************************
** Meta object code from reading C++ file 'HomeThread.h'
**
...
#include "../../WebChatSystemClient/HomeThread.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'HomeThread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 8), // "login_ok"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9), // "sign_down"
QT_MOC_LITERAL(4, 31, 6) // "onRead"

    },
    "HomeThread\0login_ok\0\0sign_down\0onRead"
};
...
void HomeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->login_ok(); break;
        case 1: _t->sign_down(); break;
        ...
        {
            typedef void (HomeThread::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HomeThread::login_ok)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (HomeThread::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HomeThread::sign_down)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject HomeThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_HomeThread.data,
      qt_meta_data_HomeThread,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void HomeThread::login_ok()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void HomeThread::sign_down()
{
